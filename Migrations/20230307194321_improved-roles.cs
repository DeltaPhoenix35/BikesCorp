...
{
    public partial class improvedroles : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SuperAdmins_Users_user_id",
                        column: x => x.user_id,
                        principalTable: "Users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminAdminRoles", x => new { x.adminsid, x.rolesid });
                    table.ForeignKey(
                        name: "FK_AdminAdminRoles_AdminRoles_rolesid",
                        column: x => x.rolesid,
                        principalTable: "AdminRoles",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdminAdminRoles_Admins_adminsid",
                        column: x => x.adminsid,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_Transactions_SuperAdmins_SuperAdminid",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2000, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "test1@test.com", "test1", "test1", "zHDskD+YjUjaNyHd1qdXodir9IVM7WCFc0bs85fsMNI=", "test1" },
                    { 2, new DateTime(2000, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@admin.com", "admin", "admin", "1UzrWHA24VbkJZO+JMC9EDNX92/fgrKOBKd0Vq0F0ho=", "admin" },
                    { 3, new DateTime(2000, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "terminaladmin@admin.com", "terminaladmin", "terminaladmin", "pJ/FhDr73GFAHcqfx8sB/XbqgYeMMCZWa0UrsIty0As=", "terminaladmin" },
                    { 4, new DateTime(2000, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "superadmin@admin.com", "superadmin", "superadmin", "vf7s74K5RA1l84GDSu0/A1J3xdggQXQekXUeXoUo0sk=", "superadmin" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 3, 7, 0, 0, 0, 0, DateTimeKind.Local), 1, 0.0, true, false, false, null, 15000.0, 0, 0 });

            migrationBuilder.InsertData(
                table: "Bicycles",
                columns: new[] { "id", "aquisutionDate", "bicycleType_Id", "earningsToDate", "isConfirmed", "isCurrentlyRented", "isReserved", "lastCheckupDate", "purchasePrice", "size", "timesRented" },
                values: new object[] { 2, new DateTime(2023, 3, 7, 0, 0, 0, 0, DateTimeKind.Local), 1, 0.0, true, false, false, null, 17000.0, 0, 0 });

            migrationBuilder.CreateIndex(
                name: "IX_AdminAdminRoles_rolesid",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_SuperAdminid",
                table: "Transactions",
                column: "SuperAdminid");
